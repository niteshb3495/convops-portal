            ...
            {!success && !error && !verifying && (
              <>
                ...
                <div className="mb-6">
                  ...
                  {/* How to find the SNS ARN */}
                  <details className="mt-3 group">
                    <summary className="flex cursor-pointer items-center gap-1.5 text-xs text-indigo-400 hover:text-indigo-300 transition-colors list-none">
                      <svg
                    ...
                    <div className="mt-3 rounded-lg border border-zinc-700 bg-zinc-900 px-4 py-3 space-y-2.5">
                      <p className="text-xs font-medium text-zinc-300">Follow these steps in your AWS Console:</p>
                      <ol className="space-y-2 text-xs text-zinc-400">
                        <li className="flex gap-2">
                          <span className="flex h-4 w-4 shrink-0 items-center justify-center rounded-full bg-zinc-700 text-zinc-300 font-semibold" style={{fontSize: "10px"}}>1</span>
                          <span>Open <span className="text-zinc-200 font-medium">AWS Console</span> and go to <span className="text-zinc-200 font-medium">CloudFormation</span></span>
                        </li>
                        <li className="flex gap-2">
                          <span className="flex h-4 w-4 shrink-0 items-center justify-center rounded-full bg-zinc-700 text-zinc-300 font-semibold" style={{fontSize: "10px"}}>2</span>
                          <span>Click on the stack named <span className="font-mono text-zinc-200">convops-setup</span></span>
                        </li>
                        <li className="flex gap-2">
                          <span className="flex h-4 w-4 shrink-0 items-center justify-center rounded-full bg-zinc-700 text-zinc-300 font-semibold" style={{fontSize: "10px"}}>3</span>
                          <span>Click the <span className="text-zinc-200 font-medium">Outputs</span> tab</span>
                        </li>
                        <li className="flex gap-2">
                          <span className="flex h-4 w-4 shrink-0 items-center justify-center rounded-full bg-zinc-700 text-zinc-300 font-semibold" style={{fontSize: "10px"}}>4</span>
                          <span>Copy the value next to the key <span className="font-mono text-zinc-200">SNSTopicArn</span> — it starts with <span className="font-mono text-zinc-400">arn:aws:sns:…</span></span>
                        </li>
                      </ol>
                      <a
                        href={`https://${region}.console.aws.amazon.com/cloudformation/home?region=${region}#/stacks?filteringStatus=active&filteringText=convops-setup`}
                        target="_blank"
                        rel="noopener noreferrer"
